 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.php">
       ...
       <h5 class="logo-text">Worth Admin</h5>
     </a>
   </div>
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="index.php">
          <i class="zmdi zmdi-assignment-o"></i> <span>Anasayfa</span>
        </a>
      </li>

      <li>
        <a href="ayarlar.php">
          <i class="zmdi zmdi-settings"></i> <span>Ayarlar</span>
        </a>
      </li>
       <li>
        <a href="bizeulas.php">
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <h6 class="mt-2 user-title"><?php echo adminnick(); ?></h6>
            <p class="user-subtitle"><?php echo adminmail(); ?></p>
            </div>
           </div>
          </a>
        </li>
